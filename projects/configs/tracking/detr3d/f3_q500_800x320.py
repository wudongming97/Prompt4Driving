...
data = dict(
    ...
    test_tracking=dict(type=dataset_type, pipeline=test_pipeline,
              ...
              data_root=data_root, test_mode=True,
              classes=class_names, modality=input_modality,
              ann_file=data_root + 'tracking_infos_val.pkl',
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        transformer=dict(
            type='Detr3DTrackingTransformer',
            decoder=dict(
...
# load_from='ckpts/f1_detr3d_e12.pth'
load_from='ckpts/f1_detr3d_fullres_e24.pth'
resume_from=None
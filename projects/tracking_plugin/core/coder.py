...
class TrackNMSFreeCoder(BaseBBoxCoder):
    ...
    def decode_single(self, cls_scores, bbox_preds, obj_idxes=None, track_scores=None, motion_forecasting=None, masks=None, prompt_preds=None):
        """Decode bboxes.
        Args:
        ...
        if masks is not None:
            ...
            if prompt_preds is not None:
                prompt_preds = prompt_preds[masks]
        ...
        if obj_idxes is not None:
            ...
            if prompt_preds is not None:
                prompt_preds = prompt_preds[bbox_index]
        ...
        final_prompt_preds = prompt_preds
        ...
        if self.post_center_range is not None:
            ...
            if final_prompt_preds is not None:
                prompt_preds = final_prompt_preds[mask]
            if obj_idxes is not None:
    ...
    def decode(self, preds_dicts):
        ...
        if 'prompt_preds' in preds_dicts:
            all_prompt_preds = [preds_dicts['prompt_preds'].clone()]
        else:
            all_prompt_preds = [None]
        ...
        for i in range(batch_size):
            predictions_list.append(self.decode_single(
                ...
                motion_forecasting[i], all_masks[i], all_prompt_preds[i]))
